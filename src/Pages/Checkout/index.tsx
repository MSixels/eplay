            ...
            <>
              ...
              <div className="margin-top">
                {payWithCard ? (
                  <>
                    ...
                    <S.Row marginTop="24px">
                      ...
                      <S.InputGroup maxWidth="123px">
                        <label htmlFor="expiresMonth">Mes de expiração</label>
                        <input
                          type="text"
                          id="expiresMonth"
                          name="expiresMonth"
                  ...
                  <p>
                    Ao optar por essa forma de pagamneto, é importante lembrar
                    que a confirmação pode leavr até 3 dias úteis, devido aos
